...
function Dashboard() {
  ...
  return dashboardData  ?  (
    <div className='min-h-screen p-4 sm:p-10 md:p-8 md:pb-0 pt-8 pb-0 flex flex-col gap-8 items-start'>
      <div className='space-y-5'>
        ...
        <div className="">
          ...
          <div className="flex flex-col items-center gap-4 max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20">
